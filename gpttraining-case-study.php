<?php
/*
Template Name: GPT Training Case Study
*/
get_header(); ?>

<main class="case-study gpttraining-case-study">

  <section class="hero">
    <h1>AI Strategy Consultants: Building Brand Awareness and Authority</h1>
    <p>As part of my Master’s program in Digital Marketing, I worked with my team on a consultancy project for gpttraining.ie (now known as aistrategy.ie), a newly launched AI consultancy firm specializing in ChatGPT and GPT-5 solutions.</p>
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/case-studies/gpttraining-hero-image.webp" alt="gpttraining-logo"/>
  </section>

  <section class="stats">
    <div class="stat-box">
    <div><strong>250K+</strong>Google Ads Impressions</div>
    </div>
    <div class="stat-box">
    <div><strong>2</strong>Consultation Leads</div>
    </div>
    <div class="stat-box">
